...
const spclSiteImages = [
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-07-06-at-02.00.54-4.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-07-06-at-02.00.54.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-07-06-at-02.00.55-2.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-07-06-at-02.00.54-4-1.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-07-06-at-02.00.54-3.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-07-06-at-02.00.54-1.jpeg",
];

export default function SPCLSitePage() {
  const [currentSlide, setCurrentSlide] = useState(0);

  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % spclSiteImages.length);
    }, 3500);
    ...
    <>
      ...
      <main className="bg-white pt-20">
        ...
        <section className="relative h-[90vh] overflow-hidden">
          ...
          {spclSiteImages.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`SPCL Site ${index + 1}`}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Discover our SPCL Site project featuring premium
                  construction quality, outstanding craftsmanship,
                  modern execution and attention to every detail
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Explore premium construction, elegant finishes and
              quality craftsmanship through our SPCL Site gallery.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
                            {[...spclSiteImages, ...spclSiteImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our SPCL Site project showcasing premium
                workmanship, elegant architecture and superior
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              ...
              to precision, premium craftsmanship and
              exceptional quality, delivering spaces
              built to inspire for years to come.
            </h2>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
          ...
          <div className="relative max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
              From premium residential interiors to large commercial
              projects, Sai Lalit Interior, Exterior & Co. delivers
              outstanding quality, elegant finishes and complete
