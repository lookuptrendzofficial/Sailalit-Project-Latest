...
const hyderabadImages = [
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-20.43.39.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-20.43.32.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-20.41.07.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-20.41.06-2.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-20.41.06-1.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-20.41.05-1.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-20.41.06.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-00.52.26-3-scaled.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-00.51.30-1-scaled.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-00.48.44-scaled.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-00.42.53.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-00.42.52-1.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-00.42.48.jpeg",
];

export default function HyderabadProjectsPage() {
  const [currentSlide, setCurrentSlide] = useState(0);

  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % hyderabadImages.length);
    }, 3500);
    ...
    <>
      ...
      <main className="bg-white pt-20">
        ...
        <section className="relative h-[90vh] overflow-hidden">
          ...
          {hyderabadImages.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`Hyderabad Project ${index + 1}`}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Explore our Hyderabad projects featuring premium interiors,
                  elegant craftsmanship, luxury finishes and innovative design
                  solutions tailored for residential and commercial spaces.
                </p>
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="mt-4 text-5xl font-bold text-gray-900">
              Hyderabad Project Showcase
            </h2>

            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Discover our Hyderabad portfolio showcasing elegant interiors,
              premium finishes and exceptional craftsmanship in every project.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
                            {[...hyderabadImages, ...hyderabadImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore Hyderabad Projects
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our Hyderabad project portfolio featuring elegant
                interiors, premium craftsmanship, modern layouts and
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              Every Hyderabad project reflects our passion for
              innovation, precision and premium craftsmanship,
              creating elegant spaces that stand the test of time.
            </h2>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
          ...
          <div className="relative max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
              Whether it's a luxury home, commercial interior or complete
              turnkey project, Sai Lalit Interior, Exterior & Co. delivers
              premium quality, elegant designs and exceptional execution
