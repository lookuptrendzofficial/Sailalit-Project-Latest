...
"https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/IMG-20260720-WA01811.jpg";
"https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/IMG-20260720-WA01801.jpg";
...
export default function LivingRoomPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % livingRoomImages.length);
    }, 3500);
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Experience elegant living room interiors crafted with
                  premium materials, timeless aesthetics and modern
                  functionality that redefine luxurious living.
                </p>
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Discover beautifully designed living rooms that combine
          ...
          {[...livingRoomImages, ...livingRoomImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore Every Living Room
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our premium collection of luxurious living room
                interiors crafted with elegant materials, sophisticated
                finishes and modern aesthetics.
              </p>
  ...
  >
    ...
    <div className="relative overflow-hidden">
      ...
      <img
        src={image}
        alt={`Living Room Interior ${index + 1}`}
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              A beautifully designed living room is
              where comfort, style and unforgettable
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="uppercase tracking-[6px] text-red-100 font-semibold">
            Let's Create Your Dream Living Room
          </p>
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
            Whether you prefer contemporary elegance, luxurious comfort
            or timeless sophistication, Sai Lalit designs living rooms
            that reflect your lifestyle with exceptional craftsmanship
