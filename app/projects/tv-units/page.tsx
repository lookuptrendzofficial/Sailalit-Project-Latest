...
export default function TVUnitsPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % tvUnitImages.length);
    }, 3500);
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Transform your entertainment space with beautifully
                  crafted TV units that combine modern aesthetics,
                  smart storage solutions and premium finishes to
                  create a stunning focal point for your living room.
                </p>
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Explore our collection of elegant TV unit designs,
              blending functionality, style and innovative storage
              to elevate your home's entertainment experience.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
              {[...tvUnitImages, ...tvUnitImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore Every TV Unit
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our premium TV unit collection featuring
                floating units, wooden entertainment walls, modern
                media consoles and customized storage solutions for
                every home.
              </p>
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              A thoughtfully designed TV unit is more than
              furniture—it becomes the centerpiece of your
              living space, combining elegance, smart storage
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="uppercase tracking-[6px] text-red-100 font-semibold">
            Let's Create Your Perfect Entertainment Space
          </p>
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
            Whether you prefer a sleek floating TV unit, a luxurious
            entertainment wall or a fully customized media console,
            Sai Lalit designs premium TV units that blend elegance,
            smart storage and exceptional craftsmanship.
          </p>
