...
export default function PfizerVizagProjectsPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % pfizerImages.length);
    }, 3500);
    ...
    <>
      ...
      <main className="bg-white pt-20">
        ...
        <section className="relative h-[90vh] overflow-hidden">
          ...
          {pfizerImages.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`Pfizer Vizag Project ${index + 1}`}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Explore our completed Pfizer Vizag projects showcasing
                  precision execution, premium workmanship, modern interiors,
                  and high-quality finishing standards tailored for industrial
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="mt-4 text-5xl font-bold text-gray-900">
              Pfizer Vizag Showcase
            </h2>

            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Discover premium execution, quality craftsmanship and modern
              industrial interiors through our Pfizer Vizag project gallery.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
                            {[...pfizerImages, ...pfizerImages].map((image, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-8 group-hover:translate-y-0 transition duration-500">
                    ...
                    <p className="text-white text-xl font-semibold">
                      Pfizer Vizag Project
                    </p>

                    <p className="text-gray-200 text-sm mt-2">
                      Industrial • Premium • Precision
                    </p>
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore Pfizer Vizag Projects
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our Pfizer Vizag project portfolio highlighting
                premium industrial interiors, quality workmanship,
                precision execution and modern design standards.
              </p>
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              Excellence is achieved through precision,
              innovation and uncompromising quality.
              Every Pfizer Vizag project reflects our
              commitment to world-class execution.
            </h2>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
          ...
          <div className="relative max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
              Whether it's an industrial facility, commercial interior,
              corporate workspace or premium residential project,
              Sai Lalit Interior, Exterior & Co. delivers exceptional
              quality, precision workmanship and complete customer satisfaction.
            </p>
