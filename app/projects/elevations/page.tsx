...
const elevationImages = [
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-01.03.39-2.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-01.03.37-1.jpeg",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/WhatsApp-Image-2026-06-23-at-00.48.29.jpeg",
  ...
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/IMG_20220123_104624-scaled.jpg",
];
...
export default function ElevationsPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % elevationImages.length);
    }, 3500);
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Transform your home's first impression with elegant,
                  contemporary and luxury elevation designs crafted
                  by Sai Lalit Interior, Exterior & Co.
                </p>
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Discover our premium elevation designs that combine
              modern architecture, elegant aesthetics and exceptional
              craftsmanship to create stunning exteriors.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
              ...
              {[...elevationImages, ...elevationImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore Elevation Collection
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our exclusive collection of premium elevation
                designs that blend creativity, elegance and modern
                architecture to create impressive exteriors.
              </p>
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              Every great home begins with an impressive exterior.
              Our premium elevation designs combine creativity,
              quality craftsmanship and timeless architecture to
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
          ...
          <div className="relative max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
              Give your home a stunning first impression with
              modern, elegant and premium elevation designs.
              Sai Lalit Interior, Exterior & Co. transforms
              ideas into remarkable architectural masterpieces.
            </p>
