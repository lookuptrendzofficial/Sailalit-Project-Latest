...
export default function MSBAreaPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % msbAreaImages.length);
    }, 3500);
    ...
    <>
      ...
      <main className="bg-white pt-20">
        ...
        <section className="relative h-[90vh] overflow-hidden">
          ...
          {msbAreaImages.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`MSB Area Project ${index + 1}`}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Explore our premium MSB Area projects showcasing elegant
                  interiors, premium finishes, innovative concepts and
                  exceptional craftsmanship designed to create modern,
                  functional and luxurious spaces.
                </p>
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Discover beautifully executed MSB Area projects that reflect
              premium quality, attention to detail and timeless design
              excellence for residential and commercial spaces.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
                            {[...msbAreaImages, ...msbAreaImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore MSB Area Projects
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our collection of premium MSB Area projects featuring
                sophisticated interiors, innovative designs and outstanding
                craftsmanship tailored to every client's vision.
              </p>
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              Great spaces are built with passion, precision and
              craftsmanship. Every MSB Area project reflects our
              commitment to premium quality, elegant aesthetics and
              lasting value.
            </h2>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
          ...
          <div className="relative max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
              From concept to completion, Sai Lalit Interior, Exterior & Co.
              delivers exceptional interiors, exteriors and turnkey solutions
              with premium craftsmanship, modern designs and unmatched quality.
            </p>
