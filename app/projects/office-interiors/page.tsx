...
const officeInteriorImages = [
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-1.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-2.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-3.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-4.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-5.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-6.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-7.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-8.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-9.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-10.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-11.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-12.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-13.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-14.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/office-15.jpg",
];
...
export default function OfficeInteriorsPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % officeInteriorImages.length);
    }, 3500);
    ...
    <>
      ...
      <main className="bg-white pt-20">
        ...
        <section className="relative h-[90vh] overflow-hidden">
          ...
          {officeInteriorImages.map((image, index) => (
            <img
              key={index}
              src={image}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Create inspiring workspaces with modern office
                  interiors designed for productivity, elegance,
                  collaboration and lasting impressions.
                </p>
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="uppercase tracking-[6px] text-red-600 font-semibold">
              Featured Office Interiors
            </p>

            <h2 className="mt-4 text-5xl font-bold text-gray-900">
              Modern Workspace Showcase
            </h2>

            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Explore premium office interiors designed to combine
              aesthetics, functionality and a productive work
              environment.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
              {[...officeInteriorImages, ...officeInteriorImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore Every Office Interior
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our premium office interior projects featuring
                executive cabins, collaborative workspaces, reception
                areas, conference rooms and modern office designs.
              </p>
    ...
    <div className="relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 translate-y-10 group-hover:translate-y-0 transition duration-500">
        ...
        <p className="mt-2 text-gray-200">
          Professional • Elegant • Productive
        </p>
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              Great office interiors inspire innovation,
              enhance productivity and create a lasting
              impression on every client and employee.
            </h2>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="uppercase tracking-[6px] text-red-100 font-semibold">
            Let's Design Your Dream Workspace
          </p>
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
            From corporate offices and executive cabins to conference
            rooms, reception areas and collaborative workspaces,
            Sai Lalit delivers premium office interiors that combine
