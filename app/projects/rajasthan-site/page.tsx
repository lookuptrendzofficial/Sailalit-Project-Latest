...
export default function RajasthanSitePage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % rajasthanImages.length);
    }, 3500);
    ...
    <>
      ...
      <main className="bg-white pt-20">
        ...
        <section className="relative h-[90vh] overflow-hidden">
          ...
          {rajasthanImages.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`Rajasthan Site ${index + 1}`}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Explore our Rajasthan project featuring premium
                  construction quality, elegant finishes, modern
                  craftsmanship and outstanding execution with
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="uppercase tracking-[6px] text-red-600 font-semibold">
              Featured Rajasthan Project
            </p>

            <h2 className="mt-4 text-5xl font-bold text-gray-900">
              Rajasthan Project Showcase
            </h2>

            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Experience premium craftsmanship, architectural excellence
              and elegant project execution through our Rajasthan site gallery.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
                            {[...rajasthanImages, ...rajasthanImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore Rajasthan Site
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our Rajasthan project featuring premium finishes,
                architectural excellence, quality craftsmanship and
                beautifully executed spaces.
              </p>
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              ...
              premium craftsmanship and timeless quality,
              creating spaces that inspire for generations.
            </h2>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
          ...
          <div className="relative max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
              Whether it's a residential, commercial or premium
              interior project, Sai Lalit Interior, Exterior & Co.
              delivers exceptional quality, elegant finishes and
