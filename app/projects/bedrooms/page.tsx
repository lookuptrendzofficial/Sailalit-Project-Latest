...
const bedroomImages = [
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-1.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-2.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-3.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-4.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-5.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-6.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-7.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-8.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-9.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-10.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-11.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-12.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-13.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-14.jpg",
  "https://lookuptrendz.com/wp-content/uploads/2026/07/bedroom-15.jpg",
];
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-8 text-lg text-gray-200 leading-8">
                Discover elegant bedroom interiors crafted with
                premium materials, modern aesthetics and timeless
                comfort to create your perfect personal retreat.
              </p>
      ...
      <section id="gallery" className="py-24 bg-[#faf8f5]">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
            A continuous showcase of our finest bedroom interiors,
        ...
        <div className="overflow-hidden">
          ...
          <div className="flex gap-8 animate-marquee whitespace-nowrap">
            {[...bedroomImages, ...bedroomImages].map((image, index) => (
      ...
      <section className="py-24 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Browse our complete collection of beautifully crafted
              bedroom interiors designed for elegance and comfort.
            </p>
      ...
      <section className="py-24 bg-[#faf8f5]">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
            Every bedroom should be a place of comfort,
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
            From elegant wardrobes to luxurious bedroom interiors,
            Sai Lalit creates spaces that combine comfort, beauty,
