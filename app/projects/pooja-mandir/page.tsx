...
export default function PoojaMandirPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % poojaMandirImages.length);
    }, 3500);
    ...
    <>
      ...
      <main className="bg-white pt-20">
        ...
        <section className="relative h-[90vh] overflow-hidden">
          ...
          {poojaMandirImages.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`Pooja Mandir ${index + 1}`}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Create a peaceful and divine space in your home with
                  beautifully designed Pooja Mandirs crafted using
                  premium materials, intricate detailing and timeless
                  elegance.
                </p>
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="uppercase tracking-[6px] text-red-600 font-semibold">
              Featured Pooja Mandirs
            </p>

            <h2 className="mt-4 text-5xl font-bold text-gray-900">
              Divine Mandir Showcase
            </h2>

            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Discover handcrafted Pooja Mandirs that blend traditional
              spirituality with contemporary interior design.
            </p>
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
              {[...poojaMandirImages, ...poojaMandirImages].map((image, index) => (
  ...
  >
    ...
    <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-8 group-hover:translate-y-0 transition duration-500">
      ...
      <p className="text-white text-xl font-semibold">
        Elegant Pooja Mandir
      </p>

      <p className="text-gray-200 text-sm mt-2">
        Divine • Peaceful • Premium
      </p>
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="mt-4 text-5xl font-bold text-gray-900">
                Explore Every Pooja Mandir
              </h2>

              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our premium collection of beautifully crafted
                Pooja Mandirs featuring traditional carvings, modern
                designs, elegant finishes and customized home temple
                solutions.
              </p>
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              A beautifully crafted Pooja Mandir brings
              peace, positivity and spiritual elegance,
              creating a sacred space where every prayer
              feels truly divine.
            </h2>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <h2 className="mt-6 text-4xl lg:text-6xl font-bold text-white leading-tight">
            Ready to Design
            <br />
            Your Dream Pooja Mandir?
          </h2>

          <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
            From elegant wooden temples to fully customized Pooja
            Mandirs with premium finishes and intricate craftsmanship,
            Sai Lalit creates divine spaces that blend spirituality,
