          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-8 text-lg text-gray-200 leading-8">
                Browse our collection of premium false ceiling designs created for homes, offices and commercial interiors..
              </p>
      ...
      <section id="gallery" className="py-24 bg-[#faf8f5]">
        ...
        <div className="text-center mb-14">
          ...
          <p className="uppercase tracking-[6px] text-red-600 font-semibold">
            Featured False Ceilings
          </p>

          <h2 className="mt-4 text-5xl font-bold text-gray-900">
            Luxury False Ceiling Showcase
          </h2>

          <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
          Discover beautifully crafted false ceiling designs that combine modern aesthetics, elegant lighting concepts and premium finishing to elevate every space.
          </p>
        ...
        <div className="overflow-hidden">
          ...
          <div className="flex gap-8 animate-marquee whitespace-nowrap">
            {[...falseCeilingImages, ...falseCeilingImages].map((image, index) => (
      ...
      <section className="py-24 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {falseCeilingImages.map((image, index) => (
      ...
      <section className="py-24 bg-[#faf8f5]">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
            Every ceiling is an opportunity to create elegance, ambience and architectural beauty.
          </h2>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
            From modern gypsum ceilings to luxurious lighting concepts, Sai Lalit designs elegant ceilings that redefine every room.
          </p>
