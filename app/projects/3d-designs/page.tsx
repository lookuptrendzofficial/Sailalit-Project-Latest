...
const design3DImages = [
  ...
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/Screenshot_2022_1001_091349.png",
  "https://businessprideawards.lookuptrendz.com/wp-content/uploads/2026/07/Screenshot_2022_1001_091425.png",
];
...
export default function ThreeDDesignsPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % design3DImages.length);
    }, 3500);
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-8 text-lg text-gray-200 leading-8">
                  Experience realistic 3D visualizations that bring your
                  dream interiors and exteriors to life before execution,
        ...
        <section id="gallery" className="py-24 bg-[#faf8f5]">
          ...
          <div className="text-center mb-14">
            ...
            <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
              Explore stunning 3D concepts crafted with creativity,
              precision and modern aesthetics to visualize your dream
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-marquee whitespace-nowrap">
                            {[...design3DImages, ...design3DImages].map((image, index) => (
        ...
        <section className="py-24 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <p className="mt-5 text-gray-600 max-w-3xl mx-auto leading-8">
                Browse our premium 3D design concepts featuring realistic
                visualizations, elegant layouts and innovative ideas that
        ...
        <section className="py-24 bg-[#faf8f5]">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-relaxed">
              Every exceptional space begins with a great vision.
              Our premium 3D designs transform ideas into realistic
              visual experiences, helping you build with confidence
              and perfection.
            </h2>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 py-24">
          ...
          <div className="relative max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg text-red-100 leading-8">
              Our realistic 3D designs help you visualize every detail
              before construction begins. Partner with Sai Lalit Interior,
              Exterior & Co. to create stunning interiors and exteriors
