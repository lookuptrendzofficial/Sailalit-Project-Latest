    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <p className="mt-8 text-lg leading-9 text-gray-600">
          With a passion for quality craftsmanship and innovative design,
          Y. Srinivasa Rao founded Sai Lalit Interior & Exterior & Co. in 2019
          with a vision to deliver elegant, functional and premium interior &
          exterior solutions for homes, commercial spaces and industries.
        </p>

        <p className="mt-6 text-lg leading-9 text-gray-600">
          Under his leadership, the company has successfully completed projects
          across residential, commercial and industrial sectors with a strong
          commitment to quality, customer satisfaction and timely execution.
        </p>
